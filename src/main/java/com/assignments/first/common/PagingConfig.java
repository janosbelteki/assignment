...
public class PagingConfig {
    ...
    public PagingConfig(int pageLimit, int pageIndex, String order, String orderBy, boolean paging) {
        ...
        //    throw new AssignmentException(HttpStatus.BAD_REQUEST);
        //}
    ...
    public static int getCorrectLimit(int pagingLimit) {
        if (pagingLimit < 1 || pagingLimit > 100) {
            throw new AssignmentException(INVALID_PAGE_LIMIT_ERROR_LABEL, "A");
        }
        return pagingLimit;
    }
    ...
    public static int getCorrectIndex(int pageIndex) {
        if (pageIndex < 0) {
            throw new AssignmentException(INVALID_PAGE_INDEX_ERROR_LABEL, "A");
        }
        return pageIndex;
    }
